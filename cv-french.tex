...
% Main sections, enclosed in an unbalanced two column layout
  ...
  \begin{minipage}[t]{0.38\linewidth}
    ...
    \par ~ \hfill \textcolor{medg}{\textit{2001 \`a 2003}}\\[5pt]
    ...
    \par ~ \hfill \textcolor{medg}{\textit{1998 \`a 2003}}\\[5pt]
    ...
    \begin{itemize}[leftmargin=10.5pt, rightmargin=0pt, labelsep=5pt, itemsep=0pt, topsep=0pt]
      \item Ruby, Ruby on Rails \hfill \fivenotes
      \item AngularJS \hfill \fournotes
      \item React/Redux \hfill \fournotes
      \item HTML/CSS/JavaScript \hfill \fournotes
